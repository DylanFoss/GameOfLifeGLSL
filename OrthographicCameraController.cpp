...
void Utils::OrthographicCameraController::Update(float deltaTime)
{
	...
	{
		m_CameraPosition.x -= cos(glm::radians(0.0f)) * m_CameraTranslationSpeed * 1-deltaTime;
		m_CameraPosition.y -= sin(glm::radians(0.0f)) * m_CameraTranslationSpeed * 1-deltaTime;
	}
	...
	{
		m_CameraPosition.x += -sin(glm::radians(0.0f)) * m_CameraTranslationSpeed * 1 - deltaTime;
		m_CameraPosition.y += cos(glm::radians(0.0f)) * m_CameraTranslationSpeed * 1 - deltaTime;
	}
